...
module.exports = async function (deployer) {
    ...
    await deployer.deploy(BitcrushStaking, crushInstance.address,1000000000000000000n,"0x0E5De84bFC1A9799a0FdA4eF0Bd13b6A20e97d89");
    let stakingInstance = await BitcrushStaking.deployed();
    
    await deployer.deploy(BitcrushBankroll, crushInstance.address, stakingInstance.address, "0x0E5De84bFC1A9799a0FdA4eF0Bd13b6A20e97d89", "0x0E5De84bFC1A9799a0FdA4eF0Bd13b6A20e97d89", 6000,1000,200,2700 );
    let bankrollInstance = await BitcrushBankroll.deployed();
    
    await deployer.deploy(BitcrushLiveWallet, crushInstance.address, bankrollInstance.address,"0x0E5De84bFC1A9799a0FdA4eF0Bd13b6A20e97d89");
